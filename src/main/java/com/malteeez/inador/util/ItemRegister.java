...
public class ItemRegister {
    ...
    public static final RegistryObject<Item> SHIRO = ITEMS.register("shiro", () -> new ItemShiro(MasterTiers.shiro, 15, 6.5F, ItemShiro.properties.group(ModItemGroups.MOD_ITEM_GROUP)));
