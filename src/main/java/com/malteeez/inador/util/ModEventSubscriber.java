/*
package com.example.inador.util;


import com.example.inador.ExampleMod;
import com.example.inador.common.items.tiers.TierShiro;
import ItemShiro;
import ModItemGroups;
...
@EventBusSubscriber(modid = InAdor.MODID, bus = EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber {
    ...
    public static <T extends IForgeRegistryEntry<T>> T setup(final T entry, final String name) {  //PAIN
        return setup(entry, new ResourceLocation(InAdor.MODID, name));
    }
